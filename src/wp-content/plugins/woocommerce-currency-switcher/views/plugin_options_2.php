...
<div class="subsubsub_section woocs_subsubsub_section">
    ...
    <div class="section">
        ...
        <?php if (time() < 1670108400): ?>
            <div style="position: relative; margin: -11px 0 11px 0;">
                <a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" target="_blank"><img width="300" src="https://pluginus.net/wp-content/uploads/2022/11/cybersale-2022-590-min.png" alt="Cybersale 2022"></a><br>
            </div>
        <?php endif; ?>
